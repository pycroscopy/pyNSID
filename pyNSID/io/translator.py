...
class Translator(object):
    ...
    def __init__(self, max_mem_mb=1024, *args, **kwargs):
        ...
        Translator object
        """
        self.max_ram = min(max_mem_mb * 1024 ** 2,
                           0.75 * get_available_memory())
    ...
    def translate(self, *args, **kwargs):
        ...
        raise NotImplementedError(
            'The translate method needs to be implemented by the child class')
    ...
    def is_valid_file(file_path, *args, **kwargs):
        ...
        if not targ_ext:
            raise NotImplementedError(
                'Either is_valid_file() has not been implemented by this translator '
        ...
        targ_ext = validate_list_of_strings(targ_ext,
                                            parm_name='(keyword argument) "extension"')
